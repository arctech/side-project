...
//				UNITY_INITIALIZE_OUTPUT(v2g, o);
			...
			//	v.vertex.y = 20.0f;
				...
				//o.worldSpacePosition.y = _TIME.y;
				//o.worldSpacePosition.y += amplitude * sin(o.worldSpacePosition.xy);
			//	o.worldSpacePosition.y = 100.0f;
				return o;
			}
			...
			fixed4 frag (g2f i) : SV_Target
			{
				...
				//_LineColor = float4(i.normal.x, i.normal.y, i.normal.z, 1.0f);
				//return _LineColor;
